...
class ActorCriticPolicy(nn.Module):
    ...
    def __init__(self, input_size, hidden_layer_size, gamma=0.95 , learning_rate=1e-3, random_seed=543):
        ...
        # actor's layer
        self.action_head = nn.Linear(self._H, 2)
    ...
    def finish_episode(self):
        ...
        self.optimizer = torch.optim.Adam(self.net.parameters(), self.learning_rate, weight_decay=1e-4)
...
def main():
    ...
    parser.add_argument('--render', action='store_false',  # store_true
