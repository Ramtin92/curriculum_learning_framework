...
def get_envs():
    ...
    envs = []
    for i_env, (width, height, no_tree, no_rock, no_table, no_fire, a_tent_area, start_tree, start_rock,
                start_pogo_sticks, type_of_env) in \
            enumerate(zip(width_array, height_array, no_trees_array,
                          no_rocks_array, no_table_array, no_fires_array, tents_area, starting_trees_array,
